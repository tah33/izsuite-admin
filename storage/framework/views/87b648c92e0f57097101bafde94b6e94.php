...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('Admin')); ?> - <?php echo e(setting('site_name', 'Resumist')); ?></title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col main-content-layout">
            ...
            <footer class="px-6 py-4 text-center text-xs text-[var(--text-muted)] border-t border-[var(--card-border)]">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(setting('site_name', 'Resumist')); ?> - Admin Panel
            </footer>
        </div>
    </div>
