...
class LoginRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Both are read straight off validated() by AuthService::login(),
            // so leaving them undeclared does not make them optional - it makes
            // them unreachable: remember-me silently stops extending the token
            // and every session is labelled with the default device name.
